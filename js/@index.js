...
<<<<<<< HEAD
require("$",function(r,t,n){n.config={name:'"tolo-fast-sprite"',description:'"Low-level versatile yet powerfull library to paint sprites on WebGL context"',author:'"tolokoban"',version:'"0.0.11"',major:"0",minor:"0",revision:"11",date:"2017-12-16T11:22:06.000Z",consts:{}};var o=null;n.lang=function(r){return void 0===r&&(window.localStorage&&(r=window.localStorage.getItem("Language")),r||(r=window.navigator.language)||(r=window.navigator.browserLanguage)||(r="fr"),r=r.substr(0,2).toLowerCase()),o=r,window.localStorage&&window.localStorage.setItem("Language",r),r},n.intl=function(r,t){var o,e,a,i,l,g,s,u=r[n.lang()],w=t[0];for(s in r)break;if(!s)return w;if(!u&&!(u=r[s]))return w;if(o=u[w],o||(u=r[s],o=u[w]),!o)return w;if(t.length>1){for(e="",l=0,a=0;a<o.length;a++)i=o.charAt(a),"$"===i?(e+=o.substring(l,a),a++,g=o.charCodeAt(a)-48,g<0||g>=t.length?e+="$"+o.charAt(a):e+=t[g],l=a+1):"\\"===i&&(e+=o.substring(l,a),a++,e+=o.charAt(a),l=a+1);e+=o.substr(l),o=e}return o}});
=======
require("$",function(r,t,n){n.config={name:'"tolo-fast-sprite"',description:'"Low-level versatile yet powerfull library to paint sprites on WebGL context"',author:'"tolokoban"',version:'"0.0.10"',major:"0",minor:"0",revision:"10",date:"2017-12-14T13:03:05.000Z",consts:{}};var o=null;n.lang=function(r){return void 0===r&&(window.localStorage&&(r=window.localStorage.getItem("Language")),r||(r=window.navigator.language)||(r=window.navigator.browserLanguage)||(r="fr"),r=r.substr(0,2).toLowerCase()),o=r,window.localStorage&&window.localStorage.setItem("Language",r),r},n.intl=function(r,t){var o,e,a,i,l,g,s,u=r[n.lang()],w=t[0];for(s in r)break;if(!s)return w;if(!u&&!(u=r[s]))return w;if(o=u[w],o||(u=r[s],o=u[w]),!o)return w;if(t.length>1){for(e="",l=0,a=0;a<o.length;a++)i=o.charAt(a),"$"===i?(e+=o.substring(l,a),a++,g=o.charCodeAt(a)-48,g<0||g>=t.length?e+="$"+o.charAt(a):e+=t[g],l=a+1):"\\"===i&&(e+=o.substring(l,a),a++,e+=o.charAt(a),l=a+1);e+=o.substr(l),o=e}return o}});
>>>>>>> cdf6bac93b0c94d25ed80b064bdab01f57a21c6c
